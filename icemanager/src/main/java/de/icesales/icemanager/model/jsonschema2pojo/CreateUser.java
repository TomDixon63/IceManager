...
public class CreateUser implements Serializable {
	...
	private final static long serialVersionUID = 7963998390386405424L;
	 ...
	 * @param id
	 */
	public CreateUser(String id, String objectName) {
		super();
		this.id = id;
	...
	public CreateUser withId(String id) {
		this.id = id;
		return this;
	}
	...
	public CreateUser withObjectName(String objectName) {
		this.objectName = objectName;
		return this;
	}
	...
	public String toString() {
		...
		sb.append(CreateUser.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
		sb.append("id");
		sb.append('=');
