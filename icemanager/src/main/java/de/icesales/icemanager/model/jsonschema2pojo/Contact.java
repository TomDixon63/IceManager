...
public class Contact implements Serializable {
	...
	private final static long serialVersionUID = 9157397855619886855L;
	 ...
	 * @param id
	 */
	public Contact(String id, String objectName) {
		super();
		this.id = id;
	...
	public Contact withObjectName(String objectName) {
		this.objectName = objectName;
		return this;
	}
	...
	public String toString() {
		...
		sb.append(Contact.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
		sb.append("id");
		sb.append('=');
