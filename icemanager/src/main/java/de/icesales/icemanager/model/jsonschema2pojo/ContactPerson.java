...
public class ContactPerson implements Serializable {
	...
	private final static long serialVersionUID = 1081192178916451403L;
	 ...
	 * @param id
	 */
	public ContactPerson(String id, String objectName) {
		super();
		this.id = id;
	...
	public ContactPerson withId(String id) {
		this.id = id;
		return this;
	}
	...
	public ContactPerson withObjectName(String objectName) {
		this.objectName = objectName;
		return this;
	}
	...
	public String toString() {
		...
		sb.append(ContactPerson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
		sb.append("id");
		sb.append('=');
