...
public class AddressCountry implements Serializable {
	...
	private final static long serialVersionUID = -5378185723765468430L;
	...
	public AddressCountry withId(String id) {
		this.id = id;
		return this;
	}
	...
	public AddressCountry withObjectName(String objectName) {
		this.objectName = objectName;
		return this;
	}
	...
	public String toString() {
		...
		sb.append(AddressCountry.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
		sb.append("id");
		sb.append('=');
