...
public class Origin implements Serializable {
	...
	private final static long serialVersionUID = -5992574259966220224L;
	 ...
	 * @param id
	 */
	public Origin(String id, String objectName) {
		super();
		this.id = id;
	...
	public Origin withObjectName(String objectName) {
		this.objectName = objectName;
		return this;
	}
	...
	public String toString() {
		...
		sb.append(Origin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
		sb.append("id");
		sb.append('=');
